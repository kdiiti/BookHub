package com.kuldeep.bookhub.adapter
...
class FavouritesRecyclerAdapter (val context: Context,val bookList: List<BookEntity>) : RecyclerView.Adapter<FavouritesRecyclerAdapter.FavouriteViewHolder>(){
    class FavouriteViewHolder(view: View): RecyclerView.ViewHolder(view){
        val txtBookName:TextView=view.findViewById(R.id.txtHello)
        val txtBookAuthor:TextView=view.findViewById(R.id.txtAndroid)
        val txtBookPrice: TextView=view.findViewById(R.id.txtPrice)
        val txtBookRating: TextView=view.findViewById(R.id.txtBookRatingInfo)
        val imgBookImage: ImageView=view.findViewById(R.id.imgBookSingleRow)
